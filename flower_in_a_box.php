...
// Correct SQL query
$newproduct = "SELECT * FROM products WHERE product_category = 'FLOWER IN A BOX'";
...
if ($result) {
    if ($result->num_rows > 0) {
        ...
        echo "No products found in NEW COLLECTION.";
    }
} else {
...
if ($result) {
    if ($result->num_rows > 0) {
        ...
        echo "<p>No products found in NEW COLLECTION.</p>";
    }
} else {
