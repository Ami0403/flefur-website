...
// Correct SQL query
$newproduct = "SELECT * FROM products WHERE product_category = 'BirthdayFlowers'";
...
if ($result) {
    if ($result->num_rows > 0) {
        ...
        echo "No products found in Birthday Flowers.";
    }
} else {
...
if ($result) {
    if ($result->num_rows > 0) {
        ...
        echo "<p>No products found in Birthday Flowers.</p>";
    }
} else {
